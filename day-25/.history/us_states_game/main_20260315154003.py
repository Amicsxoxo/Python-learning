...
while game_on:
  if answer_state in states_data:
    ...
    answer_state = (screen.textinput(title= f"{    answer_state = (screen.textinput(title= "Guess a State!" ,prompt= "Whats another states nane? ")).title()
}Guess a State!" ,prompt= "Whats another states nane? ")).title()
  else:
    pass
